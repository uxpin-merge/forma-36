...
import { Autocomplete, Grid, GridItem } from '@contentful/forma-36-react-components/dist/alpha';
  ...
  render() {
    return (
      <div className="f36-margin-bottom--m">
        <LiveProvider code={this.props.children} scope={{ ...f36Components, Grid, Autocomplete, GridItem }}>
          <Card padding="none">
